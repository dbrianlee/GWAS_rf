...
![Figure 8: Each individual tree has a different subset of predictors and thus differing classifications, both denoted by the varying colors of each decision node. Image sourced from https://syncedreview.com/2017/10/24/how-random-forest-algorithm-works-in-machine-learning/](/Users/brianlee/Dropbox/My Mac (Brian’s MacBook Pro)/Desktop/2022 FALL/STAT 494/GWAS_rf/figures/fig8.png)
